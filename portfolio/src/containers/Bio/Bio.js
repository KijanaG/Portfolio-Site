    ...
    render() {
        ...
        return (
            <div className={classes.Main}>
                <h1 style={{ fontSize: "280%", letterSpacing: "0.2em", marginTop: "50px" }}>Who Am I?</h1>
                ...
                <h4 style={{ fontWeight: "bold", margin: "45px", textAlign: "justify", lineHeight: 2 }}> &nbsp; &nbsp; Greetings, I'm Kijana 'KJ' Garrett. I'm both a pragmatist and an idealist. Both a self-starter
                                and a creative thinker. Both a student and an athlete. I was born in London, England but was raised in Manhattan Beach, CA.
                ...
                <h1>Why Tech?</h1>
                <h4 style={{ fontWeight: "bold", margin: "45px", textAlign: "justify", lineHeight: 2 }}> &nbsp; &nbsp; When I attended UW, the basketball team & I were very fortunate to have been invited to play in the inaugural
                ...
                <Coverflow width="500" height="450" displayQuantityOfSide={2} navigation={false} enableScroll={true}
                    clickable={true} active={3} currentFigureScale={1.75} otherFigureScale={0.8} enableHeading={true} >
                ...
                <h4 style={{ fontWeight: "bold", margin: "45px", textAlign: "justify", lineHeight: 2 }}> &nbsp; &nbsp; The following year, as I relocated to begin a new journey
                    at Tufts, I met an old colleague for dinner, who was previously the head of basketball analytics (and is in one of the above photos) at UW. He had transferred jobs
                ...
                <LazyLoad>
                <Coverflow width="500" height="450" displayQuantityOfSide={2} navigation={false} enableScroll={true}
                    clickable={true} active={0} currentFigureScale={1.0} otherFigureScale={0.8} enableHeading={true} >
                    <div tabIndex="0" role="menuitem">
                ...
                user's preferences. A user can rate the given song/genre and the server will update their preferences for a given mood. <br /><br /> &nbsp; &nbsp; The server uses OOP principles to create Genre Nodes
                                        ...
                                        to the conversation and decides if the mood should be changed every 50 seconds. The React Native Voice API currently has some problems with respect to its event listeners interrupting the
                                        call stack and crashing the application when in production. Currently about 40+ unanswered issues on Github surround this library and will hopefully be answered soon. A future version of the
                                        app will aim to take care of the bug that deals with the Voice API integrating with iPhone's native features.
                </h4>
                <div style={{ textAlign: "center", paddingBottom: "20px" }}>
